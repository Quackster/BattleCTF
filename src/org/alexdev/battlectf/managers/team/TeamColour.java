 ...
 ******************************************************************************/
package org.alexdev.battlectf.managers.team;
...
public enum TeamColour {
    ...
    private TeamColour(char code, int intCode, Color color) {
        this(code, intCode, false, color);
    }

    private TeamColour(char code, int intCode, boolean isFormat, Color color) {
        this.toString = new String(new char[] {COLOR_CHAR, code});
        this.color = color;
    }

    public static Color get(ChatColor color) {
        for (TeamColour enumm : TeamColour.class.getEnumConstants()) {
